...
| screenshots/ | Visual evidence | Desktop/mobile captures of an untitled article with neutral gallery images, marked code lines, and code-copy alignment with independently scrolling long lines. |
